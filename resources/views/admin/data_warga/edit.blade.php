  ...
  <div class="card p-3">
    <div class="card-header text-center py-3">
      <h5 class="mb-0 text-center">
        <strong>Edit Data Warga</strong>
      </h5>
    </div>
    <div class="card-body">
      <form action="{{ route('data-warga.update', $item->id) }}" method="POST">
        @csrf
        @method('PATCH')
        ...
        <div data-mdb-input-init class="form-outline mb-4">
          ...
          <select name='blood_type' class="form-select">
            <option disabled> Pilih Bang </option>
        ...
        <div class="text-end">
          <a href="{{ route('data-warga.index') }}" class="btn btn-secondary">Back</a>
